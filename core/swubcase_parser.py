from functools import reduce  # Need to check.

from swubcase_lexer import *
from combinators import *
from swubcase_ast import *
...
id = Tag(ID)  # Shadows built-in name "id".
...
# Specific combinator for binary operator expressions (aexp and bexp)
